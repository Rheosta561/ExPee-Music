  ...
  return (
    <div className="overflow-x-hidden w-screen">
      ...
      <div className="relative pt-20 p-3">
        ...
        <CategoryList id="div1" title="Ambience Winds and Fireside Echoes" desc="Immerse yourself in the primal sounds of Viking landscapes—howling winds, crackling fires, and the distant rumble of nature’s fury." img="https://files.oaiusercontent.com/file-DqShrTigGXW12t9SVPtZkh?se=2024-12-13T20%3A57%3A31Z&sp=r&sv=2024-08-04&sr=b&rscc=max-age%3D604800%2C%20immutable%2C%20private&rscd=attachment%3B%20filename%3D92afee57-2501-49cc-be3d-8d8bcf5670c2.webp&sig=C51XrzEC81CG0AHXAyGDnrZ7QSUmwZOMc9ScApIqEaA%3D"/>
